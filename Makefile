...
release: $(pkgname)-$(pkgver)-sources.tar.gz

$(pkgname)-$(pkgver)-sources.tar.gz:
	...
	tar \
	  ...
	  -cf "$(pkgname)-$(pkgver)-sources.tar.gz" "etc/"
	TZ=UTC touch -a -m -t 198002010000.00 "$(pkgname)-$(pkgver)-sources.tar.gz"
